...
def main():
    ...
    from executorch.examples.models.deepseek_vl2.utils.print import diff_stats
    ...
    diff_stats("python vs cpp_infer", out_py, out_hb)
    ...
    diff_stats("cpp        vs exec", out_hb, y_exec)
    diff_stats("export_cpp vs exec", out_export, y_exec)
    diff_stats("eager      vs exec", out_py, y_exec)
